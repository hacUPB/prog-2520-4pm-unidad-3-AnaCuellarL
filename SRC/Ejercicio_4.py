...
# Y se puede hacer el incremento al número que se necesite sin necesidad de escribir
#  el incremento completo.
...
while menor<=mayor:
    ...
    menor+=1
'''
#Ejercicio 3: Escribir todos los multiplos de 7 entre 0 y 100.
...
#Ejericicio: Solicitar un número al usuario e imprimir su tabla de múltiplicar hasta el 15.
